...
namespace ServerMultiThread
{
    public class multicnnNew
    {
        ...
        public static void iniciar(string puerto, string addr)
        {
            ...
            Console.WriteLine("Servidor corriendo en " + server.LocalEndpoint);
            server.Start();
        ...
        private static void AcceptCallback(IAsyncResult ar)
        {
            ...
            //EndPoint remoteEP = new Socket(AddressFamily.InterNetwork, SocketType.Stream, ProtocolType.IPv4).RemoteEndPoint;
